...
export default function PayrollOverviewWidgets() {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-4">
        ...
        <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">₹2.5M</div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-4">
        ...
        <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">₹2.1M</div>
        <div className="text-xs text-zinc-500 mt-1">This month</div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-4">
        ...
        <div className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">₹2.3M</div>
